...
public class ExtentManager {
    ...
    public synchronized static ExtentReports getInstance() {
        if (extent == null) {
            ...
            extent.addSystemInfo("Host Name", "WebAutomationFeb19Team3").addSystemInfo("Environment",
                    "QA").addSystemInfo("User Name", "Showkat Hasan").addSystemInfo("URL", "www.amazon.com");
